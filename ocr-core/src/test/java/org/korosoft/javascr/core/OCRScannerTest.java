...
public class OCRScannerTest {
    ...
    public void testScan() throws Exception {
        ...
        ImageComparator imageComparator = new ImageComparator() {
            public double compareImages(MutableImage image1, MutableImage image2) {
                MSEUtil.MSEResult result = MSEUtil.compareFast(image1, image2);
        ...
        referenceImageStorage.addReferenceImage(letter_t.image, 't');
